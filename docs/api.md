...
### Create Station
```http
POST /?page=StationCreate&name=[name]
```
...
### Update Station
```http
PUT /?page=StationUpdate&id=[id]&name=[name]
```
...
### Delete Station
```http
DELETE /?page=StationDelete&id=[id]
```
...
### Create Pollutant
```http
POST /?page=PollutantCreate&name=[name]
```
...
### Update Pollutant
```http
PUT /?page=PollutantUpdate&id=[id]&name=[name]
```
...
### Delete Pollutant
```http
DELETE /?page=PollutantDelete&id=[id]
```
